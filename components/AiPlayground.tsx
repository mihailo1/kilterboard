    ...
    <main className="ui-shell">
      <header className="space-y-3">
        <div className="flex flex-wrap items-center gap-2.5">
          ...
          <Link href="/?mode=set" className="ui-btn-quiet text-xs">
            Set
          </Link>
          <span className="ml-auto rounded-full border border-border bg-surface/80 px-2.5 py-0.5 text-[10px] uppercase tracking-wide text-faint">
            /playground
          </span>
        </div>
        <div className="flex items-center gap-2.5">
          ...
          />
          <div>
            <p className="ui-eyebrow">AI sandbox</p>
        ...
        <p className="max-w-2xl text-sm leading-relaxed text-muted">
          Try Hold AR generations and tweak holds with the paint tools. For
          saving drafts to the board editor, use{' '}
